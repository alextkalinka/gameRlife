...
#' 
#' @return Each generation of the game is returned as a data frame that contains co-ordinates for only the living cells. Used for the side-effect of animating the cellular automata as they evolve.
